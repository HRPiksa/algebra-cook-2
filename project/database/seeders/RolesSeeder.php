...
class RolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_permissions = Permission::whereIn( 'group', array( 'users', 'roles', 'pages', 'recipes' ) )->get();
        $editor_permissions = Permission::whereIn( 'group', array( 'users', 'pages', 'recipes' ) )->get();
        $user_permissions = Permission::whereIn( 'group', array( 'recipes' ) )->get();
